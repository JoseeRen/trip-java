...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`college` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`journey` ;
...
CREATE TABLE IF NOT EXISTS `trip_line`.`journey` (
  ...
  `create_time` TIMESTAMP NOT NULL COMMENT '游记创建时间',
...
-- Table `trip_line`.`day`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`day` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`follower` ;
...
CREATE TABLE IF NOT EXISTS `trip_line`.`follower` (
  ...
  INDEX `fk_follower_journey1_idx` (`journey_id` ASC),
  CONSTRAINT `fk_follower_journey1`
    FOREIGN KEY (`journey_id`)
    REFERENCES `trip_line`.`journey` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`site` ;
...
CREATE TABLE IF NOT EXISTS `trip_line`.`site` (
  ...
  `time` FLOAT(2,1) NOT NULL DEFAULT '-1.0' COMMENT '游玩时长:若为负数表示是\"事件详情\",否则为\"地点详情\"',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`sponsor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trip_line`.`user_wx` ;
